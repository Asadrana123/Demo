    ...
    return (
        <div className='slider-container'>
            ...
            <div ref={sliderRangeRef} className='slider'>
                <div tabIndex={1} onKeyDown={(e) => handleKeyDownDotOne(e)} ref={dotOne} style={{ left: `${percentageMoveDotOne}%` }} className='slider-dot'></div>
                <div tabIndex={2} onKeyDown={(e) => handleKeyDownDotTwo(e)} ref={dotTwo} style={{ left: `${percentageMoveDotTwo}%` }} className='slider-dot'></div>
            </div>
