    ...
    return (
        <div className='slider-container'>
            ...
            <div ref={sliderRangeRef} className='slider'>
                ...
                <div tabIndex={2} onKeyDown={(e) => handleKeyDownDotTwo(e, setpercentageMoveDotTwo, percentageMoveDotTwo, percentageMoveDotOne, setMaxPrice)} ref={dotTwo} style={{ left: `${percentageMoveDotTwo}%`}} className='slider-dot'></div>
            </div>
